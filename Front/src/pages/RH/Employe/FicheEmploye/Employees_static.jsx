...
function Employees_static() {
  ...
  const viewEmployeeInfo = (employeeId, infoType) => {
    console.log("Naviguer vers les informations de l'employé");
  ...
  // Ouvrir le modal avec données statiques
  ...
  const handleModalSubmit = (e) => {
    e.preventDefault();
    console.log('Modification enregistrée pour :', selectedEmployee);
    closeModal();
  };
  ...
  return (
    <div className="employees-page">
      {/* Styles intégrés */}
      <style>{`
        .employees-page { padding: 20px; font-family: Arial, sans-serif; }
        .modal {
          position: fixed;
          top: 0;
          left: 0;
        ...
        >
          <div className="modalContent">
            ...
            <form onSubmit={handleModalSubmit}>
              ...
              <button type="button" className="btn btn-secondary ms-2" onClick={closeModal}>Fermer</button>
            </form>
          </div>
        </div>
      )}
...
export default Employees_static;
